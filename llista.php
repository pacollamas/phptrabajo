...
<body>
    ...
    <table border='1'>
        <tr><th>ID</th><th>Nombre</th><th>Edad</th><th>Email</th><th>Editar</th><th>Eliminar</th></tr>
        ...
        <?php
            ...
            while ($fila = mysqli_fetch_array($resultat)) {
                ...
                $linkac="formulariactual.php?ID=" . $fila['ID'];
                $linkac2="funciones/eliminar.php?ID=" . $fila['ID'];
                echo "<td> <a href=\"$linkac\">Actualitzar</a></td>";  
                echo "<td><a href=\"$linkac2\">Eliminar</a> </td>";  
                echo "</tr>";
            }
